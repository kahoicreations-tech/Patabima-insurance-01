...
import { SafeScreen, EnhancedCard, StatCard, ActionButton, StatusBadge, SkeletonCard } from '../../components';
        ...
        <View style={styles.performanceSection}>
          ...
          <View style={styles.performanceGrid}>
            <StatCard
              ...
              style={styles.statCardQuarter}
            />
            <StatCard
              title="Paid Policies"
              value={stats.paidQuotes.toString()}
              icon="✅"
            ...
            <StatCard
              ...
              value={PricingService.formatCurrency(stats.totalEarnings).replace('KES ', 'KES ')}
              icon="💰"
              color={Colors.primary}
              trend="+12%"
              style={styles.statCardQuarter}
        ...
        <EnhancedCard>
          ...
          <View style={styles.monthlyRow}>
            <StatCard
              ...
              value={PricingService.formatCurrency(stats.monthlyEarnings)}
              icon="💵"
              color={Colors.success}
            ...
            <StatCard
              title="Next Payout"
              value={agentData.nextPayout}
              subtitle="Upcoming commission"
              icon="📅"
              color={Colors.primary}
              style={styles.statCardHalf}
            />
        ...
        <EnhancedCard>
          ...
          <View style={styles.activityGrid}>
            <View style={styles.activityItem}>
              <Text style={styles.activityValue}>{agentData.todayStats.sales}</Text>
              <Text style={styles.activityLabel}>Sales</Text>
              <StatusBadge status="Active" size="small" />
            </View>
            <View style={styles.activityDivider} />
            <View style={styles.activityItem}>
              <Text style={styles.activityValue}>KES {agentData.todayStats.production.toLocaleString()}</Text>
              <Text style={styles.activityLabel}>Production</Text>
              <StatusBadge status="Pending" size="small" />
            </View>
            <View style={styles.activityDivider} />
            <View style={styles.activityItem}>
              <Text style={styles.activityValue}>KES {agentData.todayStats.commission.toLocaleString()}</Text>
              <Text style={styles.activityLabel}>Commission</Text>
